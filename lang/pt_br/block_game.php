...
$string['help_aura_efect_text'] = '<strong>Bônus do Efeito Aura</strong> - Quando todos os estudantes do curso finalizam uma atividade, todos receberão um bônus em sua pontuação!<br/>';
$string['help_aura_efect_text_value'] = 'Valor atual do efeito Aura: ';
