...
$string['config_aura_efect'] = 'Efeito Aura';
$string['config_aura_efect_help'] = '<p>Habilitar efeito de aura, os alunos recebem um bonus de pontos caso todos finalizem uma atividade.</p>';
...
$string['help_aura_efect_text'] = '<strong>Efeito Aura</strong> - Quando todos os alunos finalizam uma atividade, a turma inteira recebe uma pontuação bônus por aquela atividade!<br/>';
$string['help_aura_efect_text_value'] = 'Valor atual do bônus de Aura: ';
$string['help_scarlat_letter_text'] = '<strong>Letra Escarlate</strong> - Cuidado! Caso você não faça uma atividade, seu nome pode aparecer para todos para que saibam porque o efeito aura ainda não foi ativado.<br/>';
$string['help_bonus_roulete_text'] = '<strong>Prêmios Aleatórios</strong> - Fique sempre atento no horário das aulas e não esqueça de ficar online. O professor pode sortear aleatóriamente um aluno presente para que este receba um bônus em sua pontuação!<br/>';
$string['help_russian_roulete_text'] = '<strong>Roleta Russa</strong> - Fique sempre atento no horário das aulas e não esqueça de ficar online. O professor pode sortear aleatóriamente um aluno ausente para que este perca parte de sua pontuação!<br/>';
$string['help_pet_text'] = '<strong>Bichinho Virtual</strong> - Entrar todo dia no curso não faz um bem somente para você. Seu bichinho virtual é alimentado e sua barra de vida varia de acordo com sua frequência!<br/>';
$string['help_calendar_text'] = '<strong>Calendário</strong> - Além do bônus diário, sua pontuação recebe um boost ainda maior conforme sua sequência de dias sem falta vai aumentando!<br/>';
