...
$string['config_aura_efect'] = 'Bonus of Aura Effect';
$string['config_aura_efect_help'] = '<p>Enable bonus for Aura effect, students get a bonus if all of them finish a activity.</p>';
